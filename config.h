...
static char *fonts[] = {
    ...
    // "TerminessNerdFontMono-Bold:size=12",
...
static const Key keys[] = {
    ...
    {MODKEY | ShiftMask, XK_Tab, spawn,
     SHCMD("xdotool type $(grep -v '^#' ~/.local/share/snippets/bookmarks | "
           "dmenu "
           "-i -l 50 | cut -d' ' -f1)")},
    ...
    {MODKEY, XK_apostrophe, spawn, SHCMD("dmenucalc")},
